...
// Egreso asociado: comisión Cami Fuks
out.push({
  id: id(), source: 'reconcile', date: '2026-04-10T00:00:00.000Z', flow: 'Egreso',
  caja_id: 'CAJ-005', caja_name: 'Caja General', category: 'Comisiones', subcategory: null,
  counterparty: 'Cami Fuks', counterparty_type: 'supplier', client_id: null, supplier_id: null,
  description: 'Comisión Cami Fuks - Oficinas Vicente López', sale_ref: '0000120',
  currency: 'USD', amount_ars: null, amount_usd: 440, exchange_rate: null,
  fixed_variable: 'Variable', expense_type: 'Marketing y Ventas', transfer: false,
  needs_review: false, review_reason: null,
});
