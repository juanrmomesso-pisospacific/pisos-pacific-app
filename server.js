...
function seedFromDump() {
  ...
  return {
    ...
    cashflow:   [...(seedArr('cashflow.seed.json') || []), ...(seedArr('cashflow-bank-extra.seed.json') || []), ...(seedArr('cashflow-mp-extra.seed.json') || []), ...(seedArr('cashflow-cash-extra.seed.json') || []), ...(seedArr('cashflow-reconcile-extra.seed.json') || [])],
