...
- **Fase B (pendiente)**: vincular cada producto a su carpeta de variedad (Colección Madera/H2O, "una carpeta por variedad") y mostrar las fotos en Inventario + PDF. El match es por nombre (los nombres de producto son largos → conviene vinculación manual o semi-auto).
