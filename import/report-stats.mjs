...
export function reportStats(movements, { source, caja }) {
  let nuevos = 0, duplicados = 0, revisar = 0, ingresos = 0, egresos = 0, actualizan = 0;
  ...
  return { source, caja, total: movements.length, nuevos, duplicados, revisar, ingresos, egresos, actualizan };
}
